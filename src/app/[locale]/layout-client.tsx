  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <header className="sticky top-0 z-50 border-b border-[var(--glass-border)]">
        {/* Glass background */}
        <div className="absolute inset-0 bg-[var(--glass-bg)] backdrop-blur-xl -z-10" />
        ...
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            >
              {/* Logo icon */}
              <div className="relative flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-br from-[var(--primary)] to-[var(--primary-hover)] text-white shadow-lg shadow-[var(--primary)]/20 transition-transform duration-200 group-hover:scale-105">
            ...
            <nav className="flex items-center gap-1 sm:gap-2">
              ...
              {/* Vote link - with highlight */}
              <Link
                href={`/${locale}/vote`}
                className={`relative px-4 py-2 rounded-xl text-sm font-medium transition-all duration-200 ${
                  isActive(`/${locale}/vote`)
                    ? 'text-white bg-gradient-to-r from-[var(--primary)] to-[var(--primary-hover)] shadow-md shadow-[var(--primary)]/20'
                    : 'text-[var(--primary)] bg-[var(--primary-light)] hover:shadow-md hover:shadow-[var(--primary)]/10'
                }`}
              >
                <span className="flex items-center gap-2">
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {/* Footer */}
      <footer className="border-t border-[var(--border)] bg-[var(--secondary)]/30">
        <div className="max-w-6xl mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-semibold text-[var(--foreground)]">Plugin Arena</p>
                <p className="text-xs text-[var(--muted)]">{t('footer.text')}</p>
              </div>
            </div>
